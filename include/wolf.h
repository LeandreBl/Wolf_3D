...
** Last update Wed Mar  1 20:21:30 2017 Léandre Blanchard
*/
...
t_pos			move_events(t_map *, t_pos);

void			repair_walls(t_map *);

void			destroy_bloc(t_map *, t_pos);

void			create_bloc(t_map *, t_pos);
...
t_dist			color_finder(int **, sfVector2f, t_dist);

sfColor			*fill_colors();

int			add_door(t_map *, t_pos);
