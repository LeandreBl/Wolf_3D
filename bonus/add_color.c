...
** Last update Tue Jan 10 23:33:05 2017 Léandre Blanchard
*/
...
t_dist		color_finder(int **map, sfVector2f ray,
			     sfColor	*colors, t_dist dist)
{
  int		i;
  sfColor	color;
...
int		add_door(t_map *map, t_win *window, t_pos pos)
{
  sfVector2f	ray;
